...
final _sliderProvider = StateProvider<double>((ref) => 0.0);
final _rangeProvider =
    StateProvider<RangeValues>((ref) => const RangeValues(0.0, 5.0));
final _cupertinoSliderProvider = StateProvider<double>((ref) => 50.0);
          ...
          SizedBox(
              ...
              child: Scaffold(
                ...
                onChanged: (double value) =>
                    ref.read(_sliderProvider.notifier).state = value,
                max: 100,
                divisions: 20,
                label: ref.watch(_sliderProvider).round().toString(),
              )))
        ]));
  }
}
          ...
          SizedBox(
              ...
              child: Scaffold(
                  body: RangeSlider(
                      ...
                      divisions: 20,
                      labels: RangeLabels(
                          ref.watch(_rangeProvider).start.round().toString(),
                          ref.watch(_rangeProvider).end.round().toString()))))
        ]));
  }
}
        ...
        child: Column(children: [
          ...
          SizedBox(
              ...
              child: Scaffold(
                ...
                value: ref.watch(_cupertinoSliderProvider),
                onChanged: (double value) =>
                    ref.read(_cupertinoSliderProvider.notifier).state = value,
                  ...
                  TableRow(children: [
                    SizedBox(
                        ...
                        child: Scaffold(
                            body: RangeSlider(
                                values: ref.watch(_rangeProvider),
                                onChanged: (RangeValues range) => ref
                                    .read(_rangeProvider.notifier)
                                    .state = range,
                                max: 100,
                                divisions: 20,
                                labels: RangeLabels(
                                    ref
                                        .watch(_rangeProvider)
                                        .start
                                        .round()
                                        .toString(),
                                    ref
                            ...
                            child: SizedBox(
                                ...
                                child: Scaffold(
                                  ...
                                  onChanged: (double value) => ref
                                      .read(_cupertinoSliderProvider.notifier)
                                      .state = value,
                                  thumbColor: Colors.blueAccent,
                                  max: 100,
                                )))))
